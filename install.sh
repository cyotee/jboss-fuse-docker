...
then
	...
	printf '\nadmin=p@ssword,Operator, Maintainer, Deployer, Auditor, Administrator, SuperUser' >> jboss-fuse/etc/users.properties
	printf '\ndev=p@ssword,Operator, Maintainer, Deployer' >> jboss-fuse/etc/users.properties
